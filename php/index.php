<?php 
  ...
  /*
    Essa verificação é feita para saber se o autor do POST foi feito pela Monetizze
  */
  // Verifica se a chave recebida do POST é segura
  $chaveUnica = $dados['chave_unica'];
  if($chaveUnica  != 'chaveUnica') {
    http_response_code(500);
  }

  // Verifica se a chave recebida do POST é segura
  $chave = $dados['produto']['chave'];
  if($chave  != 'chaveProduto') {
    http_response_code(500);
  }
